    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.statusHeader}>
          ...
          <Text style={styles.timestamp} accessibilityLabel={`Reference ID ${incident.id.slice(0, 8)}`}>
        ...
        <View style={styles.section}>
          ...
          {loadingImg ? (
            ...
            <View style={styles.noEvidence} accessibilityLabel="No valid cloud evidence found">
        ...
        {isResolved ? (
          <View style={styles.section}>
            <Text style={styles.label} accessibilityRole="header">CONTRACTOR COMPLETION REPORT</Text>
            ...
            <Text style={[styles.subLabel, { marginTop: SPACING.m }]}>REMEDIAL ACTIONS TAKEN</Text>
            <Text style={styles.notesText}>{incident.remedial_actions || "No further actions required."}</Text>
            
            <View style={styles.divider} />
            <Text style={styles.auditMeta} accessibilityLabel={`Signed off by ${incident.signed_off_by || contractor?.name || 'Assigned Specialist'}`}>
              Signed by: {incident.signed_off_by || contractor?.name || 'Assigned Specialist'}
            </Text>
          </View>
        ) : (
          <View style={styles.section}>
             ...
             <TouchableOpacity 
               ...
               accessibilityLabel={contractor ? `Reassign specialist currently ${contractor.name}` : "Assign specialist to this hazard"}
             >
...
const styles = StyleSheet.create({
  ...
  badgeText: { color: COLORS.white, fontSize: 12, fontWeight: '900', letterSpacing: 0.5 },
  timestamp: { ...TYPOGRAPHY.caption, color: COLORS.textLight, fontWeight: '800' },
  section: { 
  ...
  value: { ...TYPOGRAPHY.body, fontSize: 17, color: COLORS.primary, fontWeight: '700', lineHeight: 26 },
  ...
  expandText: { color: COLORS.white, fontSize: 12, fontWeight: '900', marginLeft: 6 },
  pdfCard: { 
    flexDirection: 'row', 
    alignItems: 'center', 
    padding: SPACING.m, 
  ...
  divider: { height: 2, backgroundColor: COLORS.lightGray, marginVertical: SPACING.m },
  auditMeta: { ...TYPOGRAPHY.body, fontSize: 14, fontWeight: '800', color: COLORS.secondary }
});