    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.header}>
          <Text style={styles.title} accessibilityRole="header">Report a Fault or Hazard</Text>
        ...
        <View style={styles.formCard}>
          ...
          <TouchableOpacity 
            ...
            accessibilityLabel={image ? "Photo evidence attached. Tap to retake." : "Attach photo evidence"}
          ...
          {image && (
            <View style={styles.previewContainer} testID="photo-preview-box">
              <Image source={{ uri: image }} style={styles.preview} accessibilityRole="image" accessibilityLabel="Preview of captured fault photo" />
              <TouchableOpacity 
