...
import { 
  View, Text, TouchableOpacity, Modal, TextInput, Image, 
  ScrollView, SafeAreaView, Switch, Alert, ActivityIndicator, StyleSheet 
} from 'react-native';
...
export const SignOffModal = ({ visible, task, onClose, onSuccess }: Props) => {
  ...
  return (
    <Modal visible={visible} animationType="slide" onRequestClose={onClose} accessibilityViewIsModal={true}>
      <SafeAreaView style={styles.modalContent} testID="sign-off-modal">
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <Text style={styles.modalHeader} accessibilityRole="header">STATUTORY CERTIFICATION</Text>
          ...
          {evidence && (
            <View style={styles.preview} testID="evidence-preview-container" accessibilityLabel="Evidence preview">
              {evidence.isImage ? (
                <Image source={{ uri: evidence.uri }} style={styles.img} accessibilityRole="image" accessibilityLabel="Selected image evidence" />
              ) : (
